...
describe('Service Tests', () => {
    ...
    describe('ProjectEstimationData Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProjectEstimationDataService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/project-estimation-data';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProjectEstimationData', () => {
